document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    if (field.tagName === 'TEXTAREA' && field.hasAttribute('data-min-words')) {
      const minWords = parseInt(field.getAttribute('data-min-words'), 10);
      const wordCount = value.split(/\s+/).filter(Boolean).length;
      if (wordCount < minWords) {
        setFieldError(field, field.dataset.errorMinwords || 'Please provide more detail.');
        return false;
      }
    }
  ...
  function showFormMessage(form, message, isSuccess) {
    ...
    msgEl.className = 'form-status-message ' + (isSuccess ? 'form-success' : 'form-error');
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    if (!isFormValid) {
      ...
      showFormMessage(form, form.dataset.errorGeneral || 'Please correct the errors above and try again.', false);
      return;
    }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '7bafab84-ba64-4e38-86a7-c095a5668c16',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '7bafab84-ba64-4e38-86a7-c095a5668c16';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to +972555691770 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7bafab84-ba64-4e38-86a7-c095a5668c16';
